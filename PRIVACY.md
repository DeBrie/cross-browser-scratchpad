...
The service stores encrypted note blobs, encryption salts, opaque account identifiers, password-verifier material, encrypted revision history, and hashed session tokens. It does not receive readable note contents or the account password. Ephemeral notes are never uploaded.
